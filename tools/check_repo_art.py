...
ART = ROOT / "docs" / "art"
SCHEMA = "public-surface-sweeper.repo-art/v1"
...
def check_seed_is_recorded(_unused: list[Path]) -> list[str]:
    ...
    svg = ART_LIB.header_svg(
        {"name": "public-surface-sweeper", "role": "x", "tagline": "y", "words": []})
    stamp = f"SEED {ART_LIB.seed_for('public-surface-sweeper') % 100000:05d}"
