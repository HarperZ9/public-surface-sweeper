# Public Surface Sweeper Brand Assets

This directory contains the public README artwork for Public Surface Sweeper.

- Hero image: `public-surface-sweeper-hero.png`
